...
<div class="content">
    <div class="content_wrapper">
        ...
        <div class="content_photo">
                <div class="content_photo_title">Фотографии</div>
            <div class="content_photo_menu_subtitle">
                <div class="content_photo_subtitle content_photo_subtitle_two">Альбомы</div>
                <div class="content_photo_subtitle ">Все фотографии</div>
            </div>
            <div class="content_photo_image_wrapper">
                <a  class="content_photo_image content_photo_image_1"></a>
                <div class="content_image_subtitle">Фото со страницы <span class="content_image_subtitle_number">100</span></div>
            </div>
            <div class="content_photo_image_wrapper">
                <div class="content_photo_image content_photo_image_2"></div>
                <div class="content_image_subtitle">Поездка в горы<span class="content_image_subtitle_number">35</span></div>
            </div>
            <div class="content_photo_image_wrapper">
                <div class="content_photo_image content_photo_image_3">
                </div>
                <div class="content_image_subtitle">Поездка на море<span class="content_image_subtitle_number">500</span></div>
            </div>
            <div class="content_photo_image_wrapper">
                <div class="content_photo_image content_photo_image_4"></div>
                <div class="content_image_subtitle">Поездка в горе<span class="content_image_subtitle_number">60</span></div>
            </div>
            <div class="content_photo_image_wrapper">
                <div class="content_photo_image content_photo_image_5">
                    <div class="content_photo_image_interactive">
                        <a href="#" class="content_photo_image_interactive_title">Концерт с друзьями <span class="content_photo_image_interactive_title_number">22</span></a>
                        <div class="content_photo_image_interactive_subtitle">Поездка с друзьями на концерт группы Scorpions в рамках их мирового тура в 2016 году</div>
                    </div>
                </div>
                <div class="content_image_subtitle">Концерт с друзьями<span class="content_image_subtitle_number">200</span></div>
            </div>
            <div class="content_photo_image_wrapper">
                <div class="content_photo_image content_photo_image_6">
                    <div class="content_photo_image_interactive">
                        <a href="#" class="content_photo_image_interactive_title">Концерт с друзьями <span class="content_photo_image_interactive_title_number">22</span></a>
                        <div class="content_photo_image_interactive_subtitle">Поездка с друзьями на концерт группы Scorpions в рамках их мирового тура в 2016 году</div>
                    </div>
                </div>
                <div class="content_image_subtitle">Поездка в никуда<span class="content_image_subtitle_number">17</span></div>
            </div>
        </div>
